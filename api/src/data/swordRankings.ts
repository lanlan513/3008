...
export const swordRankings: SwordRankingMetrics[] = [
  {
    swordId: 'ls-15',
    swordName: '干将剑',
    swordAlias: '雄剑',
    ...
    heritageLengthDetail: {
      forgingYear: '公元前514年',
      lastKnownYear: '公元300年',
      yearsInCirculation: 814,
      holderCount: 12,
    },
    ...
    relatedFiguresDetail: {
      famousHolders: 8,
      relatedSwordsmen: 22,
      historicalFigures: 15,
    },
    comprehensiveScore: 93.25,
    rank: 1,
    previousRank: 2,
    rankChange: 1,
    trend: 'up',
  ...
  },
  {
    ...
    historicalInfluenceDetail: {
      majorEvents: 4,
      historicalSignificance: 46,
      dynastyInfluence: 42,
    },
    citationCount: 118,
    citationCountDetail: {
      historicalRecords: 42,
      academicPapers: 32,
      literaryWorks: 44,
    },
    heritageLength: 88,
    heritageLengthDetail: {
      forgingYear: '公元前514年',
      lastKnownYear: '公元280年',
      yearsInCirculation: 794,
      holderCount: 10,
    },
  ...
  },
  {
    ...
    heritageLengthDetail: {
      ...
      lastKnownYear: '公元前1600年',
      yearsInCirculation: 1097,
      holderCount: 8,
    },
  ...
  },
  {
    ...
    heritageLengthDetail: {
      forgingYear: '公元前496年',
      lastKnownYear: '公元前473年',
      yearsInCirculation: 23,
      holderCount: 5,
    },
    ...
    relatedFiguresDetail: {
      famousHolders: 6,
      relatedSwordsmen: 18,
      historicalFigures: 14,
    },
    comprehensiveScore: 84.40,
    rank: 4,
    previousRank: 5,
    rankChange: 1,
    trend: 'up',
  ...
  },
  {
    ...
    heritageLengthDetail: {
      forgingYear: '公元前210年',
      lastKnownYear: '公元295年',
      yearsInCirculation: 505,
      holderCount: 8,
    },
  ...
  },
  {
    ...
    historicalInfluenceDetail: {
      majorEvents: 5,
      historicalSignificance: 42,
      dynastyInfluence: 38,
    },
    citationCount: 88,
    citationCountDetail: {
      historicalRecords: 38,
      academicPapers: 25,
      literaryWorks: 25,
    },
    heritageLength: 82,
    heritageLengthDetail: {
      forgingYear: '公元前516年',
      lastKnownYear: '公元前484年',
      yearsInCirculation: 32,
      holderCount: 6,
    },
    ...
    relatedFiguresDetail: {
      famousHolders: 7,
      relatedSwordsmen: 18,
      historicalFigures: 11,
    },
    comprehensiveScore: 81.95,
    rank: 6,
    previousRank: 6,
    rankChange: 0,
    trend: 'stable',
  ...
  },
  {
    ...
    heritageLengthDetail: {
      forgingYear: '公元前950年',
      lastKnownYear: '公元前900年',
      yearsInCirculation: 50,
      holderCount: 4,
    },
  ...
  },
  {
    ...
    historicalInfluenceDetail: {
      majorEvents: 3,
      historicalSignificance: 38,
      dynastyInfluence: 37,
    },
    citationCount: 68,
    citationCountDetail: {
      historicalRecords: 22,
      academicPapers: 24,
      literaryWorks: 22,
    },
    heritageLength: 75,
  ...
  },
  {
    ...
    heritageLengthDetail: {
      forgingYear: '公元前2697年',
      lastKnownYear: '公元前2070年',
      yearsInCirculation: 627,
      holderCount: 5,
    },
    relatedFiguresCount: 28,
    relatedFiguresDetail: {
  ...
  },
  {
    ...
    heritageLengthDetail: {
      forgingYear: '公元前240年',
      lastKnownYear: '公元前210年',
      yearsInCirculation: 30,
      holderCount: 4,
    },
  ...
  },
  {
    ...
    citationCount: 58,
    citationCountDetail: {
      historicalRecords: 20,
      academicPapers: 18,
      literaryWorks: 20,
    },
    heritageLength: 72,
    heritageLengthDetail: {
      forgingYear: '公元前2070年',
      lastKnownYear: '公元前1600年',
      yearsInCirculation: 470,
      holderCount: 6,
    },
  ...
  },
  {
    ...
    historicalInfluenceDetail: {
      majorEvents: 3,
      historicalSignificance: 32,
      dynastyInfluence: 30,
    },
    citationCount: 52,
    citationCountDetail: {
      historicalRecords: 16,
      academicPapers: 18,
      literaryWorks: 18,
    },
    heritageLength: 68,
    heritageLengthDetail: {
      forgingYear: '公元前1100年',
      lastKnownYear: '公元前771年',
      yearsInCirculation: 329,
      holderCount: 6,
    },
  ...
  },
  {
    ...
    heritageLengthDetail: {
      forgingYear: '公元前2697年',
      lastKnownYear: '公元前2600年',
      yearsInCirculation: 97,
      holderCount: 3,
    },
    relatedFiguresCount: 22,
    relatedFiguresDetail: {
  ...
  },
  {
    ...
    heritageLengthDetail: {
      forgingYear: '公元前500年',
      lastKnownYear: '公元650年',
      yearsInCirculation: 1150,
      holderCount: 5,
    },
...
export const rankingTrendData: RankingTrendData[] = [
  {
    year: '上古',
    dynasty: '上古',
    avgComprehensiveScore: 72.5,
    avgHistoricalInfluence: 82.0,
    avgCitationCount: 50.0,
    avgHeritageLength: 71.6,
    avgRelatedFigures: 30.5,
    swordCount: 6,
  },
  {
    year: '夏',
    dynasty: '夏',
    avgComprehensiveScore: 66.8,
    avgHistoricalInfluence: 70.0,
    avgCitationCount: 58.0,
    avgHeritageLength: 72.0,
    avgRelatedFigures: 24.0,
    swordCount: 1,
  },
  {
    year: '周',
    dynasty: '周',
    avgComprehensiveScore: 68.9,
    avgHistoricalInfluence: 73.5,
    avgCitationCount: 62.0,
    avgHeritageLength: 74.0,
    avgRelatedFigures: 24.0,
    swordCount: 2,
  },
  {
    year: '春秋',
    dynasty: '春秋',
    avgComprehensiveScore: 81.7,
    avgHistoricalInfluence: 87.6,
    avgCitationCount: 88.4,
    avgHeritageLength: 81.0,
    avgRelatedFigures: 34.8,
    swordCount: 5,
  },
  {
    year: '战国',
    dynasty: '战国',
    avgComprehensiveScore: 70.6,
    avgHistoricalInfluence: 73.5,
    avgCitationCount: 69.0,
    avgHeritageLength: 69.0,
    avgRelatedFigures: 28.5,
    swordCount: 2,
  },
  {
    year: '汉',
    dynasty: '汉',
    avgComprehensiveScore: 83.95,
    avgHistoricalInfluence: 90.0,
    avgCitationCount: 92.0,
    avgHeritageLength: 75.0,
    avgRelatedFigures: 35.0,
    swordCount: 1,
  },
];
...
export function calculateComprehensiveScore(metrics: {
...
export function getSwordRankingCalculationDetail(swordId: string) {
  ...
  return {
    ...
    finalScore: sword.comprehensiveScore,
